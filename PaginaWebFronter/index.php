...
<section class="mbr-section mbr-section__container" id="map2-1" data-rv-view="12" style="background-color: rgb(255, 255, 255); padding-top: 80px; padding-bottom: 80px;">
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                <div class="mbr-map"><iframe frameborder="0" style="border:0" src="https://www.google.com/maps/embed/v1/place?key=AIzaSyAEIpgj38KyLFELm2bK9Y7krBkz1K-cMq8&amp;q=place_id:ChIJi8GkbHbuFZYROiTMdGti9QQ" allowfullscreen=""></iframe></div>
            </div>
        </div>
    </div>
</section>
